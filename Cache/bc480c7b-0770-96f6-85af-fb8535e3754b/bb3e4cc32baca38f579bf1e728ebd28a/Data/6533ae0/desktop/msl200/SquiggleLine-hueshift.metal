...
float Output_N2=0.0;
float param_1=(*sc_set0.UserUniforms).uvScale;
Output_N2=param_1;
float2 CoordsOut_N1=float2(0.0);
CoordsOut_N1=((UVCoord_N0-(*sc_set0.UserUniforms).Port_Center_N001)*float2(Output_N2))+(*sc_set0.UserUniforms).Port_Center_N001;
...
float param_12=0.0;
bool l9_7=param_10&&(!param_8);
float l9_8=1.0;
float l9_9=param_4.x;
int l9_10=param_7.x;
if (l9_10==1)
{
l9_9=fract(l9_9);
...
if (l9_10==2)
{
float l9_11=fract(l9_9);
float l9_12=l9_9-l9_11;
float l9_13=step(0.25,fract(l9_12*0.5));
l9_9=mix(l9_11,1.0-l9_11,fast::clamp(l9_13,0.0,1.0));
}
}
param_4.x=l9_9;
float l9_14=param_4.y;
int l9_15=param_7.y;
if (l9_15==1)
{
l9_14=fract(l9_14);
...
float l9_21=param_4.x;
float l9_22=param_9.x;
float l9_23=param_9.z;
bool l9_24=l9_20;
float l9_25=l9_8;
float l9_26=fast::clamp(l9_21,l9_22,l9_23);
float l9_27=step(abs(l9_21-l9_26),9.9999997e-06);
l9_25*=(l9_27+((1.0-float(l9_24))*(1.0-l9_27)));
l9_21=l9_26;
param_4.x=l9_21;
l9_8=l9_25;
bool l9_28=param_10;
...
float l9_30=param_4.y;
float l9_31=param_9.y;
float l9_32=param_9.w;
bool l9_33=l9_29;
float l9_34=l9_8;
...
float2 l9_37=param_4;
bool l9_38=param_5;
float3x3 l9_39=param_6;
if (l9_38)
{
l9_37=float2((l9_39*float3(l9_37,1.0)).xy);
}
float2 l9_40=l9_37;
param_4=l9_40;
float l9_41=param_4.x;
int l9_42=param_7.x;
bool l9_43=l9_7;
float l9_44=l9_8;
if ((l9_42==0)||(l9_42==3))
...
param_4.y=l9_52;
l9_8=l9_55;
float2 l9_63=param_4;
int l9_64=param_2;
int l9_65=param_3;
float l9_66=param_12;
float2 l9_67=l9_63;
int l9_68=l9_64;
int l9_69=l9_65;
...
if (l9_68==0)
{
l9_70=float3(l9_67,0.0);
}
else
{
if (l9_68==1)
{
l9_70=float3(l9_67.x,(l9_67.y*0.5)+(0.5-(float(l9_69)*0.5)),0.0);
}
else
{
l9_70=float3(l9_67,float(l9_69));
}
}
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_10)
{
l9_74=mix(param_11,l9_74,float4(l9_8));
}
float4 l9_75=l9_74;
Output_N3=l9_75;
float4 HSV_N5=float4(0.0);
float3 param_13=Output_N3.xyz;
float3 l9_76=float3(0.0);
float3 l9_77=param_13;
float3 l9_78=fast::clamp(l9_77,float3(0.0),float3(1.0));
param_13=l9_78;
float l9_79=fast::max(fast::max(param_13.x,param_13.y),param_13.z);
l9_76.z=l9_79;
float l9_80=l9_79-fast::min(fast::min(param_13.x,param_13.y),param_13.z);
float3 l9_81=float3(0.0,0.33333334,0.66666669)+(((param_13.yzx-param_13.zxy)*0.16666667)/float3(l9_80));
float2 l9_82;
if (l9_80==0.0)
{
l9_82=float2(0.0);
...
l9_82=float2(l9_83,l9_80/l9_79);
}
l9_76=float3(l9_82.x,l9_82.y,l9_76.z);
float3 l9_85=l9_76;
HSV_N5=float4(l9_85,Output_N3.w);
float Value1_N9=0.0;
float Value2_N9=0.0;
float Value3_N9=0.0;
float Value4_N9=0.0;
float4 param_14=HSV_N5;
float param_15=param_14.x;
float param_16=param_14.y;
float param_17=param_14.z;
float param_18=param_14.w;
Value1_N9=param_15;
Value2_N9=param_16;
Value3_N9=param_17;
Value4_N9=param_18;
float Output_N8=0.0;
float param_19=(*sc_set0.UserUniforms).Tweak_N8;
Output_N8=param_19;
float Output_N7=0.0;
Output_N7=Value1_N9+Output_N8;
float4 Output1_N10=float4(0.0);
Output1_N10=float4(Output_N7,Value2_N9,Value3_N9,Value4_N9);
float4 RGB_N6=float4(0.0);
float3 param_20=Output1_N10.xyz;
float3 l9_86=param_20.zzz;
float l9_87=3.0*fract(param_20.x+0.16666667);
float l9_88=2.0*fract(l9_87);
float l9_89=param_20.y;
float l9_90=fast::clamp(l9_89,0.0,1.0);
float2 l9_91=l9_86.yz-((float2(1.0,l9_88)-float2(fast::max(0.0,l9_88-1.0)))*(param_20.z*l9_90));
l9_86=float3(l9_86.x,l9_91.x,l9_91.y);
if (l9_87>=1.0)
{
l9_86=l9_86.zxy;
}
...
float3 l9_92=l9_86;
RGB_N6=float4(l9_92,Output1_N10.w);
FinalColor=RGB_N6;
...
float4 l9_96=fast::max(param_22,float4(0.0));
float4 param_23=l9_96;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float l9_100=l9_99;
float l9_101=l9_100;
float l9_102=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_101;
float3 l9_103=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_97.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
float4 l9_110=gl_FragCoord;
float2 l9_111=l9_110.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_116=l9_115;
int l9_117=l9_116;
float3 l9_118=float3(l9_112,0.0);
int l9_119=l9_114;
int l9_120=l9_117;
if (l9_119==1)
{
l9_118.y=((2.0*l9_118.y)+float(l9_120))-1.0;
}
float2 l9_121=l9_118.xy;
l9_113=l9_121;
}
else
{
...
float3 l9_142=l9_141;
float4 l9_143=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_142.xy,bias(l9_136));
float4 l9_144=l9_143;
float4 l9_145=l9_144;
l9_107=l9_145;
}
float4 l9_146=l9_107;
float3 l9_147=l9_146.xyz;
float3 l9_148=l9_147;
float3 l9_149=l9_105.xyz;
float3 l9_150=definedBlend(l9_148,l9_149,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_106=float4(l9_150.x,l9_150.y,l9_150.z,l9_106.w);
float3 l9_151=mix(l9_147,l9_106.xyz,float3(l9_105.w));
l9_106=float4(l9_151.x,l9_151.y,l9_151.z,l9_106.w);
l9_106.w=1.0;
float4 l9_152=l9_106;
param_24=l9_152;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_153=float4(in.varScreenPos.xyz,1.0);
param_24=l9_153;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_154=gl_FragCoord;
float l9_155=fast::clamp(abs(l9_154.z),0.0,1.0);
float4 l9_156=float4(l9_155,1.0-l9_155,1.0,1.0);
param_24=l9_156;
}
else
{
float4 l9_157=param_24;
float4 l9_158=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_158=float4(mix(float3(1.0),l9_157.xyz,float3(l9_157.w)),l9_157.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_159=l9_157.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_159=fast::clamp(l9_159,0.0,1.0);
}
l9_158=float4(l9_157.xyz*l9_159,l9_159);
}
else
{
l9_158=l9_157;
...
float3 param_25=in.varPos;
float4 param_26=FinalColor;
FinalColor=sc_OutputMotionVectorsIfNeeded(param_25,param_26,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_27=FinalColor;
float4 l9_164=param_27;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_164.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_164;
return out;
}
} // FRAGMENT SHADER
