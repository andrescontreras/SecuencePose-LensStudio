...
#endif
vec2 l9_0=((varPackedTex.xy-Port_Center_N001)*vec2(uvScale))+Port_Center_N001;
int l9_1;
...
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),baseTexLayout,l9_1);
vec4 l9_24=texture2D(baseTex,l9_23.xy,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
vec3 l9_26=clamp(l9_25.xyz,vec3(0.0),vec3(1.0));
float l9_27=l9_26.x;
float l9_28=l9_26.y;
float l9_29=l9_26.z;
float l9_30=max(max(l9_27,l9_28),l9_29);
float l9_31=l9_30-min(min(l9_27,l9_28),l9_29);
vec3 l9_32=vec3(0.0,0.33333334,0.66666669)+(((l9_26.yzx-l9_26.zxy)*0.16666667)/vec3(l9_31));
vec2 l9_33;
if (l9_31==0.0)
{
l9_33=vec2(0.0);
...
l9_33=vec2(l9_34,l9_31/l9_30);
}
float l9_36=l9_33.x+Tweak_N8;
vec4 l9_37=vec4(l9_36,l9_33.y,l9_30,l9_25.w);
float l9_38=3.0*fract(l9_36+0.16666667);
float l9_39=2.0*fract(l9_38);
vec2 l9_40=l9_37.zz-((vec2(1.0,l9_39)-vec2(max(0.0,l9_39-1.0)))*(l9_30*clamp(l9_33.y,0.0,1.0)));
vec3 l9_41=vec3(l9_37.z,l9_40.x,l9_40.y);
vec3 l9_42;
if (l9_38>=1.0)
{
l9_42=l9_41.zxy;
...
vec4 l9_44=vec4(l9_43,l9_25.w);
#if (sc_BlendMode_AlphaTest)
{
if (l9_25.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_25.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_47=clamp(l9_25.w*2.0,0.0,1.0);
}
#else
{
float l9_48;
...
{
l9_48=clamp(dot(l9_44.xyz,vec3(l9_25.w)),0.0,1.0);
}
#else
{
float l9_49;
...
{
l9_50=(1.0-dot(l9_44.xyz,vec3(0.33333001)))*l9_25.w;
}
#else
{
float l9_51;
...
{
l9_51=(1.0-clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0))*l9_25.w;
}
#else
{
float l9_52;
...
{
l9_52=clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0)*l9_25.w;
}
#else
{
float l9_53;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_54=clamp(dot(l9_44.xyz,vec3(1.0)),0.0,1.0)*l9_25.w;
}
#else
{
float l9_55;
...
{
l9_55=dot(l9_44.xyz,vec3(0.33333001))*l9_25.w;
}
#else
{
float l9_56;
...
#if (sc_FramebufferFetch)
{
l9_60=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_60=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_61,sc_ScreenTextureLayout,l9_62).xy,0.0);
}
#endif
vec3 l9_63=mix(l9_60.xyz,definedBlend(l9_60.xyz,l9_44.xyz).xyz,vec3(l9_25.w));
...
#if (sc_Voxelization)
{
l9_65=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_66;
#if (sc_OutputBounds)
{
float l9_67=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_66=vec4(l9_67,1.0-l9_67,1.0,1.0);
}
#else
{
vec4 l9_68;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_68=vec4(mix(vec3(1.0),l9_44.xyz,vec3(l9_25.w)),l9_25.w);
}
#else
{
vec4 l9_69;
...
#endif
l9_69=vec4(l9_44.xyz*l9_70,l9_70);
}
#else
{
l9_69=l9_44;
...
vec4 l9_73=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_71,vec4(0.0)));
vec4 l9_74=clamp(l9_73,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_75=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_75-0.0039215689)),min(1.0,l9_75+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_76=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
...
#endif
int l9_77=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_76).xy);
float l9_78=packValue(l9_77);
int l9_85=int(l9_74.w*255.0);
float l9_86=packValue(l9_85);
sc_writeFragData0Internal(vec4(packValue(l9_77),packValue(l9_77),packValue(l9_77),packValue(l9_77)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_78,packValue(l9_77),packValue(l9_77),packValue(l9_77)));
sc_writeFragData2(vec4(l9_86,packValue(l9_85),packValue(l9_85),packValue(l9_85)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_89).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_94==0)
{
l9_97=texture2D(sc_OITAlpha0,l9_89);
l9_96=texture2D(sc_OITDepthLow0,l9_89);
l9_95=texture2D(sc_OITDepthHigh0,l9_89);
}
else
{
l9_97=vec4(0.0);
...
if (l9_94==1)
{
l9_100=texture2D(sc_OITAlpha1,l9_89);
l9_99=texture2D(sc_OITDepthLow1,l9_89);
l9_98=texture2D(sc_OITDepthHigh1,l9_89);
}
else
{
l9_100=l9_97;
...
if (any(notEqual(l9_98,vec4(0.0)))||any(notEqual(l9_99,vec4(0.0))))
{
int l9_101[8]=l9_90;
unpackValues(l9_98.w,l9_94,l9_101);
unpackValues(l9_98.z,l9_94,l9_101);
unpackValues(l9_98.y,l9_94,l9_101);
unpackValues(l9_98.x,l9_94,l9_101);
unpackValues(l9_99.w,l9_94,l9_101);
unpackValues(l9_99.z,l9_94,l9_101);
unpackValues(l9_99.y,l9_94,l9_101);
unpackValues(l9_99.x,l9_94,l9_101);
int l9_110[8]=l9_91;
unpackValues(l9_100.w,l9_94,l9_110);
unpackValues(l9_100.z,l9_94,l9_110);
unpackValues(l9_100.y,l9_94,l9_110);
unpackValues(l9_100.x,l9_94,l9_110);
}
l9_94++;
continue;
}
...
vec4 l9_115=texture2D(sc_OITFilteredDepthBoundsTexture,l9_89);
vec2 l9_116=l9_115.xy;
int l9_117;
#if (sc_SkinBonesCount>0)
{
l9_117=encodeDepth(((1.0-l9_115.x)*1000.0)+getDepthOrderingEpsilon(),l9_116);
}
#else
{
l9_117=0;
...
#endif
int l9_118=encodeDepth(viewSpaceDepth(),l9_116);
vec4 l9_119;
l9_119=l9_74*l9_74.w;
vec4 l9_120;
int l9_121=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_121<8)
{
int l9_122=l9_90[l9_121];
int l9_123=l9_118-l9_117;
bool l9_124=l9_122<l9_123;
bool l9_125;
if (l9_124)
{
l9_125=l9_90[l9_121]>0;
}
else
{
l9_125=l9_124;
...
if (l9_125)
{
vec3 l9_126=l9_119.xyz*(1.0-(float(l9_91[l9_121])/255.0));
l9_120=vec4(l9_126.x,l9_126.y,l9_126.z,l9_119.w);
}
else
{
l9_120=l9_119;
...
sc_writeFragData0Internal(l9_119,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
#else
{
sc_writeFragData0Internal(l9_73,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
