...
{
float4 l9_108=out.sc_FragData0;
l9_107=l9_108;
}
else
{
...
float4 l9_145=l9_107;
float3 l9_146=l9_145.xyz;
float3 l9_147=l9_146;
float3 l9_148=l9_105.xyz;
...
l9_106=float4(l9_149.x,l9_149.y,l9_149.z,l9_106.w);
float3 l9_150=mix(l9_146,l9_106.xyz,float3(l9_105.w));
l9_106=float4(l9_150.x,l9_150.y,l9_150.z,l9_106.w);
l9_106.w=1.0;
float4 l9_151=l9_106;
param_24=l9_151;
}
else
{
...
FinalColor=sc_OutputMotionVectorIfNeeded(param_25,in.varPosAndMotion,in.varNormalAndMotion);
float4 param_26=FinalColor;
float4 l9_163=param_26;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_163.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.sc_FragData0=l9_163;
return out;
}
} // FRAGMENT SHADER
