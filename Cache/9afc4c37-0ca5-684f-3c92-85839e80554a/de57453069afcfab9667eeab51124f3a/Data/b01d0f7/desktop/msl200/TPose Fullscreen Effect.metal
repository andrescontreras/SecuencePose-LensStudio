...
{
float4 l9_107=out.sc_FragData0;
l9_106=l9_107;
}
else
{
float4 l9_108=gl_FragCoord;
float2 l9_109=l9_108.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_114=l9_113;
int l9_115=l9_114;
float3 l9_116=float3(l9_110,0.0);
int l9_117=l9_112;
int l9_118=l9_115;
if (l9_117==1)
{
l9_116.y=((2.0*l9_116.y)+float(l9_118))-1.0;
}
float2 l9_119=l9_116.xy;
l9_111=l9_119;
}
else
{
...
int l9_130=l9_125;
float2 l9_131=l9_123;
int l9_132=sc_ScreenTextureLayout_tmp;
int l9_133=l9_130;
float l9_134=l9_124;
...
float3 l9_140=l9_139;
float4 l9_141=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_140.xy,bias(l9_134));
float4 l9_142=l9_141;
float4 l9_143=l9_142;
l9_106=l9_143;
}
float4 l9_144=l9_106;
float3 l9_145=l9_144.xyz;
float3 l9_146=l9_145;
float3 l9_147=l9_104.xyz;
float3 l9_148=definedBlend(l9_146,l9_147,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_105=float4(l9_148.x,l9_148.y,l9_148.z,l9_105.w);
float3 l9_149=mix(l9_145,l9_105.xyz,float3(l9_104.w));
l9_105=float4(l9_149.x,l9_149.y,l9_149.z,l9_105.w);
l9_105.w=1.0;
float4 l9_150=l9_105;
param_17=l9_150;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_151=float4(in.varScreenPos.xyz,1.0);
param_17=l9_151;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_152=gl_FragCoord;
float l9_153=fast::clamp(abs(l9_152.z),0.0,1.0);
float4 l9_154=float4(l9_153,1.0-l9_153,1.0,1.0);
param_17=l9_154;
}
else
{
float4 l9_155=param_17;
float4 l9_156=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_156=float4(mix(float3(1.0),l9_155.xyz,float3(l9_155.w)),l9_155.w);
}
else
{
...
{
l9_157=fast::clamp(l9_157,0.0,1.0);
}
l9_156=float4(l9_155.xyz*l9_157,l9_157);
}
else
{
l9_156=l9_155;
