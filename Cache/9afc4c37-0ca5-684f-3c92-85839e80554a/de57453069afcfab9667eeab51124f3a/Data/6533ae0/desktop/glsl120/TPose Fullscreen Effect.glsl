...
//sampler sampler sc_OITCommonSampler 0:19
//sampler sampler sc_ScreenTextureSmpSC 0:21
//sampler sampler screenTexSmpSC 0:24
//texture texture2D intensityTexture 0:0:0:16
//texture texture2D sc_OITAlpha0 0:3:0:19
//texture texture2D sc_OITAlpha1 0:4:0:19
//texture texture2D sc_OITDepthHigh0 0:5:0:19
//texture texture2D sc_OITDepthHigh1 0:6:0:19
//texture texture2D sc_OITDepthLow0 0:7:0:19
//texture texture2D sc_OITDepthLow1 0:8:0:19
//texture texture2D sc_OITFilteredDepthBoundsTexture 0:9:0:19
//texture texture2D sc_OITFrontDepthTexture 0:10:0:19
//texture texture2D sc_ScreenTexture 0:12:0:21
//texture texture2D screenTex 0:15:0:24
...
//spec_const bool screenTexHasSwappedViews 74 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_V_screenTex 78 -1
...
//spec_const int sc_StereoViewID 87 0
//spec_const int screenTexLayout 88 0
//SG_REFLECTION_END
...
#endif
bool l9_3=(int(SC_USE_CLAMP_TO_BORDER_screenTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_screenTex)!=0));
float l9_4=l9_1.x;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTex,SC_SOFTWARE_WRAP_MODE_V_screenTex).x);
float l9_5=l9_4;
float l9_6=l9_1.y;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTex,SC_SOFTWARE_WRAP_MODE_V_screenTex).y);
float l9_7=l9_6;
vec2 l9_8;
float l9_9;
...
{
l9_10=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTex,SC_SOFTWARE_WRAP_MODE_V_screenTex).x==3;
}
#else
{
l9_10=(int(SC_USE_CLAMP_TO_BORDER_screenTex)!=0);
}
#endif
float l9_11=l9_5;
float l9_12=1.0;
sc_ClampUV(l9_11,screenTexUvMinMax.x,screenTexUvMinMax.z,l9_10,l9_12);
float l9_13=l9_11;
float l9_14=l9_12;
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_screenTex)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTex,SC_SOFTWARE_WRAP_MODE_V_screenTex).y==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_screenTex)!=0);
}
#endif
float l9_16=l9_7;
float l9_17=l9_14;
sc_ClampUV(l9_16,screenTexUvMinMax.y,screenTexUvMinMax.w,l9_15,l9_17);
l9_9=l9_17;
...
#endif
vec2 l9_18=sc_TransformUV(l9_8,(int(SC_USE_UV_TRANSFORM_screenTex)!=0),screenTexTransform);
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTex,SC_SOFTWARE_WRAP_MODE_V_screenTex).x,l9_3,l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTex,SC_SOFTWARE_WRAP_MODE_V_screenTex).y,l9_3,l9_22);
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),screenTexLayout,l9_2);
vec4 l9_25=texture2D(screenTex,l9_24.xy,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_screenTex)
{
l9_26=mix(screenTexBorderColor,l9_25,vec4(l9_23));
}
#else
{
l9_26=l9_25;
...
#endif
vec4 l9_27=colorTint*l9_26;
vec4 l9_28=mix(l9_26,l9_27,vec4(intensity));
float l9_29=l9_28.w;
...
#if (sc_FramebufferFetch)
{
l9_45=sc_readFragData0_Platform();
}
#else
{
vec2 l9_46=sc_ScreenCoordsGlobalToView(l9_0);
int l9_47;
...
#endif
l9_45=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_46,sc_ScreenTextureLayout,l9_47).xy,0.0);
}
#endif
vec3 l9_48=mix(l9_45.xyz,definedBlend(l9_45.xyz,l9_28.xyz).xyz,vec3(l9_29));
...
#if (sc_Voxelization)
{
l9_50=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_51;
#if (sc_OutputBounds)
{
float l9_52=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_51=vec4(l9_52,1.0-l9_52,1.0,1.0);
}
#else
{
vec4 l9_53;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_53=vec4(mix(vec3(1.0),l9_28.xyz,vec3(l9_29)),l9_29);
}
#else
{
vec4 l9_54;
...
#endif
l9_54=vec4(l9_28.xyz*l9_55,l9_55);
}
#else
{
l9_54=l9_28;
...
vec4 l9_58=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_56,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_60-0.0039215689)),min(1.0,l9_60+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_61=sc_ScreenCoordsGlobalToView(l9_0);
...
sc_writeFragData0Internal(vec4(packValue(l9_62),packValue(l9_62),packValue(l9_62),packValue(l9_62)),sc_UniformConstants.x,sc_ShaderCacheConstant);
